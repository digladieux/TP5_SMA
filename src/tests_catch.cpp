...
TEST_CASE("MonthOfPregnancy", "[character]")
{
    ...
    Character *character2 = new FemaleCharacter(Date());
    (static_cast<FemaleCharacter*>(character1))->setTimePregnancy(Date(1,1,50));
    (static_cast<FemaleCharacter*>(character1))->getMonthPregnancy(Date(1, 2, 60));
    CHECK(0 == (static_cast<FemaleCharacter*>(character1))->getMonthPregnancy(Date(1, 2, 60)));
